...
namespace Herbzhub.Infrastructure.Services
{
    public static class ForgotPassword
    {
        ...
        private static string GetBase64FromPath(string imagePath)
        {
            // Load the image from the specified path and convert it to base64
            byte[] imageBytes = File.ReadAllBytes(imagePath);
            return Convert.ToBase64String(imageBytes);
        }

        public static string GenerateHtmlMail(string tokenurl, string appurl, string token, string imagePath)
        {
            var base64Image = GetBase64FromPath(imagePath);
                            ...
                            <table style=""background-color: #f2f3f8; max-width:670px;  margin:0 auto;"" width=""100%"" border=""0""
                                ...
                                <tr>
                                    <td style=""text-align:center;"">
                                        <img width=""60"" src=""data:image/png;base64,{base64Image}"" 
                                            title=""logo"" alt=""logo"">
                                    </td>
                                </tr>
                                <tr>
