...
using Herbzhub.Models.Validations;
...
namespace Herbzhub.Api.ExtensionMethods
{
    public static class ExtensionMethodServices
    {
        ...
        public static void AddApplicationServices(this IServiceCollection services)
        {
            ...
            services.AddTransient<IValidator<ManufactureRequest>, ManufactureRequestValidator>();
            services.AddTransient<IValidator<AddressRequest>, AddressRequestValidator>();
            services.AddTransient<IValidator<BusinessDetails>, BusinessDetailsValidator>();
        }
